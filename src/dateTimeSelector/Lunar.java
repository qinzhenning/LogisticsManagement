 ...
 * @Title: Lunar.java
 * @Package 公历转农历
 * @Description: TODO 阳历转农历
 * @author 刘伯乐
 * @date 2013-6-17 下午12:34:39
 * @version V1.0
 */
...
public class Lunar {
	...
	private String chineseNumber[] = { "零", "一", "二", "三", "四", "五", "六", "七",
			"八", "九", "十", "十一", "十二" };
	...
	public String animalsYear() {
		String[] Animals = new String[] { "鼠", "牛", "虎", "兔", "龙", "蛇", "马",
				"羊", "猴", "鸡", "狗", "猪" };
	...
	private String cyclicalm(int num) {
		String[] Gan = new String[] { "甲", "乙", "丙", "丁", "戊", "己", "庚", "辛",
				"壬", "癸" };
		String[] Zhi = new String[] { "子", "丑", "寅", "卯", "辰", "巳", "午", "未",
				"申", "酉", "戌", "亥" };
	...
	public String getChinaDate() {
		calChinaDate();
		return year + "年" + (leap ? "闰" : "") + chineseNumber[month] + "月"
